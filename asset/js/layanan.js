...
function showContent(section) {
    document.querySelectorAll('.content-ekstrakurikuler').forEach(div => {
...
document.addEventListener("DOMContentLoaded", function () {
    const buttons = document.querySelectorAll(".button-ekstrakurikuler");

    const firstButton = document.querySelector(".button-ekstrakurikuler");
