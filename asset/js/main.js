...
function showContent(section) {
    document.querySelectorAll('.content-layanan').forEach(div => {
...
document.addEventListener("DOMContentLoaded", function () {
    const buttons = document.querySelectorAll(".button-layanan");

    const firstButton = document.querySelector(".button-layanan");
